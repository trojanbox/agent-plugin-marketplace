...
6. **形成作品表达合同**：结合第一层身份和读者体验，确认整体调性、语言倾向、叙事距离、描写/对白/节奏倾向及明确不要的表达方式。
7. **停止在场景设计层**：当关键 Movement 已有足够场景支撑，剩余未知主要是动作、对白、正式段落、局部节奏与写作发现时，整理 Story Development Plan 并移交 `writing/fiction-writing`。
