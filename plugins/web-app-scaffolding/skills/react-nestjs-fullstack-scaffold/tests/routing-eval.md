...
| A006 | PASS_COMPOSITION | Fullstack 保留主任务语义；apps/api 目录与 Module 粒度由 Node/Nest Skill 的架构 reference 决定，后端保持粗粒度多 Module，AppModule 仅做 Composition Root，Module 内按职责目录组织 |
